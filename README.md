...
Application destiné à être utilisé comme outil d'assistance pour gérer ses comptes en utilisant une banque virtuelle.

# Utilisation

L'application utilise un système de banque virtuelle que vous pouvez gérer, vous choisissez complètement combien d'argent vous insérez et retirez.
Il y'a 5 parties différentes:

- **Tutorial:** Explique brièvement le fonctionnement de l'application aux nouveaux utilisateurs.
